			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					<ul class="nav navbar-nav">
						...
						<li><a href="{{ url('/user/1') }}">Corys profile</a></li>
					</ul>

					<ul class="nav navbar-nav navbar-right">

						<li><input type="search" name="get_user" class="nav_search_form btn btn-default" placeholder="Search Users"/></li>
						<li><input type="submit" class="nav_search_submit btn btn-default"/></li>
